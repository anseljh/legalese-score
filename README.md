...
* [flesch-kincaid](https://github.com/wooorm/flesch-kincaid) and [smog-formula](https://github.com/wooorm/smog-formula) are components of [automated-readability](https://github.com/wooorm/automated-readability), a module for [Retext](https://github.com/wooorm/retext), all by [@wooorm](https://github.com/wooorm)
